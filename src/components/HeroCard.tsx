    ...
    <div className="bg-white rounded-[2rem] p-8 lg:p-12 border border-gray-100 shadow-sm relative overflow-hidden h-full flex flex-col justify-center">
      ...
      <div className="relative z-10 max-w-2xl">
        ...
        <h1 className="font-display text-5xl sm:text-6xl lg:text-[5rem] font-bold leading-[1.05] italic mb-6 text-brand-navy tracking-tight">
          ...
          <span className="text-[#1c1c1f] border-[#171515]">The Ultimate Home Refresh.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10">
          <a
            href="#quote"
            className="bg-[#0B3A63] hover:bg-[#072541] text-white px-8 py-4 rounded-xl font-bold uppercase tracking-wide transition-colors text-center shadow-[0_4px_14px_0_rgba(11,58,99,0.39)] hover:shadow-[0_6px_20px_rgba(11,58,99,0.23)] hover:-translate-y-0.5 duration-200"
          >
            Request My Quote
          </a>
          <a
            href="#results"
            className="bg-white border-2 border-gray-200 text-gray-700 hover:border-gray-300 hover:bg-gray-50 px-8 py-4 rounded-xl font-bold uppercase tracking-wide transition-colors text-center"
          >
            View Results
          </a>
        </div>
